 ...
 */
class FVlcMediaPlayerAudioSample
...
public:
	...
	/** Virtual destructor. */
	virtual ~FVlcMediaPlayerAudioSample()
	{
		FreeBuffer();
	}
...
class FVlcMediaAudioSamplePool : public TMediaObjectPool<FVlcMediaPlayerAudioSample> { };
