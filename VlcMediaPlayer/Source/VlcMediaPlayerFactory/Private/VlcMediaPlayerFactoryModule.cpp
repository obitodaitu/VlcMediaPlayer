...
#include "../../VlcMediaPlayer/Public/IVlcMediaPlayerModule.h"


#define LOCTEXT_NAMESPACE "FVlcMediaPlayerFactoryModule"


/**
 * Implements the VlcMediaFactory module.
 */
class FVlcMediaPlayerFactoryModule
...
public:
	...
	{
		auto VlcMediaModule = FModuleManager::LoadModulePtr<IVlcMediaPlayerModule>("VlcMediaPlayer");
...
public:
	...
	virtual void StartupModule() override
	{
		...
		{
			ISettingsSectionPtr SettingsSection = SettingsModule->RegisterSettings("Project", "Plugins", "VlcMediaPlayer",
				LOCTEXT("VlcMediaSettingsName", "VLC Media Player"),
				LOCTEXT("VlcMediaSettingsDescription", "Configure the VLC Media Player plug-in."),
				GetMutableDefault<UVlcMediaPlayerSettings>()
			);
		}
#endif //WITH_EDITOR
	...
	virtual void ShutdownModule() override
	{
		...
		if (SettingsModule != nullptr)
		{
			SettingsModule->UnregisterSettings("Project", "Plugins", "VlcMediaPlayer");
		}
#endif //WITH_EDITOR
	}
...
IMPLEMENT_MODULE(FVlcMediaPlayerFactoryModule, VlcMediaPlayerFactory);
